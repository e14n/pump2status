...
module.exports = (config) ->
  ...
  Gplus =
    ...
    getOAuth: (site) ->
      new OAuth(request_token_endpoint, access_token_endpoint, client_id, client_secret, "1.0", site.url("/authorized-for-gplus"), "HMAC-SHA1", null, # nonce size; use default
